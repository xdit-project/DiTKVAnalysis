...
def main():
    ...
    for num_inference_steps in [20, 40, 80, 160]:
        ...
        fig1.savefig(os.path.join('figs', f'pixart_kv_stats_{num_inference_steps}_steps.png'))
        fig2.savefig(os.path.join('figs', f'pixart_activation_stats_{num_inference_steps}_steps.png'))
        output.save(os.path.join('results', f'pixart_output_{num_inference_steps}_steps.png'))
